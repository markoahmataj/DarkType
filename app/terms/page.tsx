  ...
  return (
    <main className="min-h-screen bg-dark-950 flex flex-col items-center px-4 py-16">
      <div className="max-w-xl w-full">
        <h1 className="text-3xl font-black text-[#f3f3f3] mb-10">Terms of Service</h1>
        ...
        <div className="space-y-8 text-[#8a8a8a] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-bold text-[#f3f3f3] mb-2">Entertainment Only</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#f3f3f3] mb-2">Digital Product</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#f3f3f3] mb-2">Payment Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#f3f3f3] mb-2">Refund Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#f3f3f3] mb-2">User Responsibilities</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#f3f3f3] mb-2">Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#f3f3f3] mb-2">Changes to Terms</h2>
